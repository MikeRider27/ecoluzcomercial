...
public class Ciudad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcMousePanel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/ciudad.jpg"))); // NOI18N
        jcMousePanel1.setVisibleLogo(false);
        jcMousePanel1.setLayout(null);
        jPanel1.add(jcMousePanel1);
        jcMousePanel1.setBounds(10, 100, 370, 160);
        ...
        jcMousePanel2.setBounds(-50, -60, 650, 610);

        setSize(new java.awt.Dimension(616, 585));
    ...
    private void btnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnuevoActionPerformed
        ...
        bd.autonumerico("ciudad", "id_ciudad", txtcodigo);
        limpiar_campos1();
    ...
    private void cargar_tabla() {
        ...
        try {
            ...
            bd.listar_datos("SELECT id_ciudad, ciu_descri\n"
                    + "  FROM ciudad where id_ciudad::text like'%" + txtbuscar.getText() + "%' or ciu_descri ilike '%" + txtbuscar.getText() + "%';");
...
//        txtcodigo.setText("");
    ...
    private void recuperar_datos() {
        try {
            bd.listar_datos("SELECT id_ciudad, ciu_descri\n"
                    + "  FROM ciudad where id_ciudad=" + txtcodigo.getText() + ";");
            if (bd.resultado.next()) {
                txtdescripcion.setText(bd.resultado.getString("ciu_descri"));
            }
        } catch (Exception e) {
