...
public class Caja extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcMousePanel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/caja.jpg"))); // NOI18N
        jcMousePanel1.setVisibleLogo(false);
        jcMousePanel1.setLayout(null);
        jPanel1.add(jcMousePanel1);
        jcMousePanel1.setBounds(40, 100, 310, 160);
    ...
    private void btnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnuevoActionPerformed
        ...
        bd.autonumerico("caja", "id_caja", txtcodigo);
        limpiar_campos1();
    ...
    private void cargar_tabla() {
        ...
        try {
            ...
            bd.listar_datos("SELECT id_caja , caja_descri\n"
                    + "  FROM caja where id_caja::text like'%" + txtbuscar.getText() + "%' or caja_descri ilike '%" + txtbuscar.getText() + "%';");
            while (bd.resultado.next()) {
                tab.addRow(new Object[]{bd.resultado.getString("id_caja"),
                    bd.resultado.getString("caja_descri")});
    ...
    private void recuperar_datos() {
        try {
            bd.listar_datos("SELECT id_caja, caja_descri\n"
                    + "  FROM caja where id_caja=" + txtcodigo.getText() + ";");
            if (bd.resultado.next()) {
                txtdescripcion.setText(bd.resultado.getString("caja_descri"));
            }
        } catch (Exception e) {
