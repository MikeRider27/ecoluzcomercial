...
public class Marca extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcMousePanel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/marca.jpg"))); // NOI18N
    ...
    private void btnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnuevoActionPerformed
        ...
        bd.autonumerico("marca", "id_marca", txtcodigo);
        limpiar_campos1();
    ...
    private void cargar_tabla() {
        ...
        try {
            ...
            bd.listar_datos("SELECT id_marca, mar_descri\n"
                    + "  FROM marca where id_marca::text like'%" + txtbuscar.getText() + "%' or mar_descri ilike '%" + txtbuscar.getText() + "%';");
    ...
    private void recuperar_datos() {
        try {
            bd.listar_datos("SELECT id_marca, mar_descri\n"
                    + "  FROM marca where id_marca=" + txtcodigo.getText() + ";");
            if (bd.resultado.next()) {
                txtdescripcion.setText(bd.resultado.getString("mar_descri"));
            }
        } catch (Exception e) {
