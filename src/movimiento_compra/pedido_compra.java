...
public class pedido_compra extends javax.swing.JDialog {
...
//    DecimalFormat formateador = new DecimalFormat("#,##0"); //formato para separador de miles
    ...
    public pedido_compra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        controlpresu = new control_presupuesto(this);
    ...
    private void initComponents() {
        ...
        txtfecha.setBounds(110, 70, 80, 19);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 102, 102));
        jLabel1.setText("Pedido de Compra");
        jPanel3.add(jLabel1);
        jLabel1.setBounds(40, 10, 190, 22);

        jcMousePanel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagen/pedido de compra.jpg"))); // NOI18N
        jcMousePanel3.setVisibleLogo(false);
        jPanel3.add(jcMousePanel3);
        jcMousePanel3.setBounds(320, 10, 240, 140);
        ...
        txtcodigo.setBounds(40, 30, 60, 20);
        ...
        txtdescripcion.setBounds(140, 30, 100, 20);
        ...
        txtcantidad.setBounds(310, 30, 70, 20);
        ...
        setSize(new java.awt.Dimension(621, 580));
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pedido_compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pedido_compra dialog = new pedido_compra(new javax.swing.JFrame(), true);
